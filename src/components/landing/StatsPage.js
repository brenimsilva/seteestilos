...
export default function StatsPage(props) {
  ...
  return (
    <div className={style.container}>
      <h1 className={style.title}>SEU ESTILO É: <span className={style.estilo_negrito}>{props.mostVoted}</span></h1>
      ...
      <button onClick={() => {window.location.reload();}}>Retornar a pagina inicial</button>
      {
        //TESTE FACEBOOK
      }
