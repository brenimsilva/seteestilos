      ...
      <div className={style.body}>
        <Card>
          ...
          <p className={style.text}>
            ...
            que desenvolveu na década de 80 o conceito de “estilos universais” a
            partir de estudos sobre perfis e comportamentos de consumidores e
            foram organizados em sete estilos:
          </p>
          <p className={style.text}>
          ...
          <p className={style.text}>
            Segundo essa ideia, nossa imagem não é formada por um único estilo,
            mas sim pela combinação de 2 ou 3 deles Esse teste foi realizado
            para lhe ajudar a descobrir seu modo de se mostrar ao mundo, seu
            estilo.
          </p>
